...
# uvicorn app.main:app --reload --host 0.0.0.0 --port "{APP_ENDPOINT_PORT:-8045}" --log-level "${APP_VERBOSITY:-info}" --reload
exec uvicorn app.main:app --reload --host 0.0.0.0 --port 8000 --log-level info --reload
